...
class Interface:
    ...
    def __generate_info(self, word: str) -> dict[str, Any]:
        """
    ...
    def send_email(self, text: str) -> None:
        ...
        password = 'did-you-really-think-I-was-going-to-put-my-password-here?'
...
class ValidateInfo:
    ...
    def success_info(self, word: str) -> dict[str, Any]:
        """
    ...
    def failure_info(self) -> dict[str, Any]:
        """
